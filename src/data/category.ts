...
export const category = [
  {
    ...
    name: "ชุดไทย",
    sub: [
      { id: "S01", name: "ชุดไทยจิตรลดา-ชุดไทยแขนกระบอก" },
      { id: "S23", name: "ชุดไทยบรมพิมาน-ชุดเสื้อลูกไม้ผ้าไทย" },
      { id: "S02", name: "ชุดไทยจักรี-ชุดนางนพมาศ" },
      { id: "S03", name: "ชุดไทยชาย-ชุดราชประแตนชาย" },
      { id: "S09", name: "ชุดไทยรัชกาลที่ 1-2-3" },
      { id: "S04", name: "ชุดไทยรัชกาลที่ 4-ชุดพี่หมื่น-ชุดการะเกด" },
      { id: "S05", name: "ชุดไทยรัชกาลที่ 5" },
      { id: "S07", name: "ชุดไทยรัชกาลที่ 6-7" },
      ...
      { id: "S14", name: "ชุดกุมาร-ชุดเงาะป่า-ชุดฤาษี" },
  ...
  },
  {
    ...
    sub: [
      ...
      { id: "S09", name: "ชุดเวียดนาม-ชุดอ๊าวหญ่าย" },
  ...
  },
  {
    ...
    sub: [
      {
        id: "S01",
        name: "ชุดแดนซ์เซอร์หญิง-ชุดนักร้องหญิง",
        sub: [
          { id: "E01", name: "ชุดรวมสี" },
          { id: "E02", name: "ชุดสีส้ม" },
          { id: "E03", name: "ชุดสีทอง" },
          { id: "E04", name: "ชุดสีฟ้า" },
          { id: "E05", name: "ชุดสีเขียว" },
          { id: "E06", name: "ชุดสีแดง" },
          { id: "E07", name: "ชุดสีรุ้งคัลเลอร์ฟูล" },
          { id: "E08", name: "ชุดสีน้ำเงิน" },
          { id: "E09", name: "ชุดสีดำ/สีดำทอง" },
          { id: "E10", name: "ชุดสีเงินกลิตเตอร์/สีขาวเพชร" },
          { id: "E11", name: "ชุดสีม่วง/สีม่วงเพชร" },
          { id: "E12", name: "ชุดสีชมพู/สีชมพูเพชร" },
          { id: "E13", name: "ชุดกระโปรงขนนกรวมสี" },
          { id: "E14", name: "ชุดกระโปรงรุ้งอิตาลีรวมสี" },
          { id: "E15", name: "ชุดเกาะอกประดับเพชรรวมสี/สูทกลิตเตอร์หญิง" },
          { id: "E16", name: "ชุดพ็อบ ฯลฯ บอดี้สูท โปรง กั๊ก เฟอร์ แยกชิ้น" },
        ],
      },
  ...
  },
  {
    ...
    sub: [
      ...
      { id: "S08", name: "ชุดทิงเกอร์เบลล์-ปีเตอร์แพน" },
