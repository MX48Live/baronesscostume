...
export const category = [
  {
    ...
    sub: [
      ...
      { id: "S03", name: "1.4 ชุดไทยชาย-ชุดราชประแตนชาย" },
    ...
    sub: [
      {
        ...
        sub: [
          { id: "E02", name: "4.1.1 ชุดสีส้ม" },
          { id: "E03", name: "4.1.2 ชุดสีทอง" },
          { id: "E04", name: "4.1.3 ชุดสีฟ้า" },
          { id: "E05", name: "4.1.4 ชุดสีเขียว" },
          { id: "E06", name: "4.1.5 ชุดสีแดง" },
          { id: "E07", name: "4.1.6 ชุดสีรุ้งคัลเลอร์ฟูล" },
          { id: "E08", name: "4.1.7 ชุดสีน้ำเงิน" },
          { id: "E09", name: "4.1.8 ชุดสีดำ/สีดำทอง" },
          { id: "E10", name: "4.1.9 ชุดสีเงินกลิตเตอร์/สีขาวเพชร" },
          { id: "E11", name: "4.1.10 ชุดสีม่วง/สีม่วงเพชร" },
          { id: "E12", name: "4.1.11 ชุดสีชมพู/สีชมพูเพชร" },
          { id: "E13", name: "4.1.12 ชุดกระโปรงขนนกรวมสี" },
          { id: "E14", name: "4.1.13 ชุดกระโปรงรุ้งอิตาลีรวมสี" },
          {
            id: "E15",
            name: "4.1.14 ชุดเกาะอกประดับเพชรรวมสี/สูทกลิตเตอร์หญิง",
          },
          {
            id: "E16",
            name: "4.1.15 พ็อบ บอดี้สูท กระโปรง กั๊ก เฟอร์ แยกชิ้น ฯลฯ",
          },
        ],
      },
      { id: "S02", name: "4.2 ชุดนักร้องชาย-ชุดแดนซ์เซอร์ชาย" },
      { id: "S03", name: "4.3 ชุดคัลเลอร์ฟูล-ชาย-หญิง" },
    ],
  },
